...
Connect with me
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/tanisha-mangal-18980031a/)
...
**Systems**
`OpenCL` `IR Design` `Backend Abstraction` `Codegen` `NumPy C API`

**Computer Vision**
`Object Detection` `Image Segmentation` `OpenCV` `ONNX` `Transfer Learning`

**Scientific Computing**
`Astropy` `SciPy` `MNE` `Signal Processing` `FITS I/O` `Spectral Analysis`

**Languages**
`Python` `C++` `SQL`

**Tools**
`Git` `Linux` `Jupyter` `Weights & Biases` `Docker`
